						...
						success : function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("Iso_code");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.Iso_code === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							return this.waitFor({
								id : "lineItemsTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name: "text", value: "<ToCityPlural> (" + iNumberOfItems + ")"}),
								success : function () {
