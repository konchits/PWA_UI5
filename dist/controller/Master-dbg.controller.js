sap.ui.define([
	...
	return BaseController.extend("demo.PWAUI5APP.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "demo.PWAUI5APP.view.ViewSettingsDialog",
					controller: this
		...
		_showDetail : function (oItem) {
			...
			this.getRouter().navTo("object", {
				objectId : oItem.getBindingContext().getProperty("Iso_code")
			}, bReplace);
		},
